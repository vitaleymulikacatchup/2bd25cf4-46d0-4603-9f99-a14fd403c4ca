...
export const metadata: Metadata = {
  title: "Delicious Pizzeria - Home of Tasty Pizzas",
  description: "Discover the best pizzas in town at Delicious Pizzeria. Order your favorite pizza today!",
  keywords: "pizzeria, pizza, gourmet, custom pizzas, order online",
